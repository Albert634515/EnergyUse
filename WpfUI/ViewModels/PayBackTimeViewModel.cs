...
public class PayBackTimeViewModel : ViewModelBase
{
    ...
    private void LoadAddressSettings()
    {
        ...
        QualityReduction = _settings.GetDecimal($"QualityReductionSolarPanels_A{SelectedAddress.Id}", 0);
    ...
    private async Task<bool> ValidateInputAsync()
    {
        ...
        int startYear = PurchaseDate.Year;
        int endYear = PurchaseDate.Year + MaxYears;
